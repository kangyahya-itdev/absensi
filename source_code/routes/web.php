...
Route::get('/data-absen-karyawan', [AbsenController::class, 'getDataAbsen'])->middleware('admin')->name('get-absensi-karyawan');
...
Route::get('/laporan-bulanan', [KaryawanController::class, 'laporanBulanan'])->middleware('auth');
...
Route::get('/data-gaji-karyawan', [KaryawanController::class, 'getDataGajiBulanan'])->middleware('admin')->name('get-gaji-karyawan');
Route::get('/data-upah-karyawan', [KaryawanController::class, 'getUpahKaryawan'])->middleware('admin')->name('get-upah-karyawan');
Route::post('/save-upah-karyawan', [KaryawanController::class, 'setUpahKaryawan'])->middleware('admin')->name('save-upah-karyawan');
Route::get('/get-upah-by-id/{id}', [KaryawanController::class, 'getUpahById'])->middleware('admin')->name('get-upah-by-id');
Route::put('/update-upah-karyawan/{id}', [KaryawanController::class, 'updateUpahKaryawan'])->middleware('admin')->name('update-upah-karyawan');
Route::delete('/delete-upah-karyawan/{id}', [KaryawanController::class, 'deleteUpahKaryawan'])->middleware('admin')->name('delete-upah-karyawan');
Route::get('/get-jabatan-karyawan/{id}', [KaryawanController::class, 'getJabatanKaryawan'])->middleware('admin')->name('get-jabatan-karyawan');
Route::get('/get-gaji-karyawan-by-id', [KaryawanController::class, 'getGajiKaryawanById'])->middleware('admin')->name('get-gaji-karyawan-by-id');
Route::get('/get-karyawan-by-jabatan', [KaryawanController::class, 'getKaryawanByJabatan'])->middleware('admin')->name('get-karyawan-by-jabatan');
